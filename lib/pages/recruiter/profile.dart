...
import '../candidate/personalDetails.dart';
import '../candidate/professionalDetails.dart';
import '../first.dart';
...
class _BodyState extends State<Body> {
  ...
  Future<void> countApplications() async {
    try {
      final count = await AppStuff().countRApps(uid);
      setState(() {
        apps = count;
      });
    } catch (error) {
  ...
  Future<void> getJobs() async {
    try {
      final count = await JobStuff().countJobs(uid);
      setState(() {
        jobs = count;
      });
    } catch (error) {
                ...
                child: Center(
                  child: IntrinsicHeight(
                    child: Row(
                        ...
                        children: [
                          Stat(value: jobs.toString(), text: "Jobs"),
